            ...
            const videoURL = "https://github.com/WebHost6/vers/raw/refs/heads/main/assets/inst.mp4"; // Replace with your actual video URL
    ...
    if (newWindow === null || newWindow.closed || typeof newWindow.closed == 'undefined') {
        ...
        alert('Please allow popups for the launcher to work, then refresh');
    } else {
        newWindow.close();
    }
